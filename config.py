...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5896985949:AAHsrZ_WTXQmsFf4gDpljkA9ibd2EMjB_J8")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001850766501"))
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to start the bot and join the channel\n\nKindly Please join Channel</b>")
